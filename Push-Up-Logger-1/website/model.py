...
class Mess(db.Model):
    ...
    mess_adminid = db.Column(db.Integer, db.ForeignKey('admin_user.adminid'), nullable=False)
...
class Staff(db.Model):
    ...
    user_idmodel = db.Column(db.Integer, db.ForeignKey('admin_user.adminid'), nullable=False)
